...
struct StoryBrain {
    ...
    func getStoryLabel() -> String {
        return stories[getNumberStory].title
    }
    
    func getStoryChoiceOne() -> String {
        return stories[getNumberStory].choice1
    }
    
    func getStoryChoiceTwo() -> String {
        return stories[getNumberStory].choice2
    }
    
    mutating func nextHistory(userChoice: String) {
        let currentStory = stories[getNumberStory]
        if userChoice == currentStory.choice1 {
            getNumberStory = currentStory.choice1Destination
        } else if userChoice == currentStory.choice2 {
            getNumberStory = currentStory.choice2Destination
        }
    }
}
